...
def index():
    ...
    if request.method == "POST":
        ...
        if 'textfile' in request.files and request.files['textfile'].filename:
            ...
            if not question:
                session["history"].append({"question": "", "answer": "Please enter a question."})
                return render_template("index.html", history=session["history"], files=files_metadata)

            filename = file.filename
            if not filename:
                session["history"].append({"question": question, "answer": "Please select a valid file."})
                return render_template("index.html", history=session["history"], files=files_metadata)
            ...
            if error:
                session["history"].append({"question": question, "answer": error})
                return render_template("index.html", history=session["history"], files=files_metadata)
            ...
            session["history"].append({"question": question, "answer": answer, "file_used": filename})
            ...
            if not selected_file_hash or not question:
                session["history"].append({"question": question or "", "answer": "Please select a file and enter a question."})
                return render_template("index.html", history=session["history"], files=files_metadata)
            ...
            session["history"].append({"question": question, "answer": answer, "file_used": file_name})
